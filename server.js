...
const USER_AGENT = 'TatryFieldPhase2/0.3.0 (+source-backed route tracks; safety-first hiking guide)';
...
server.listen(PORT,()=>console.log(`TATRY FIELD Phase 2.6 → http://localhost:${PORT}`));
