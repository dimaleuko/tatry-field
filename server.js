...
const USER_AGENT = 'TatryFieldPhase2/0.3.1 (+source-backed route tracks; safety-first hiking guide)';
...
server.listen(PORT,()=>console.log(`TATRY FIELD Phase 2.7 → http://localhost:${PORT}`));
